...
public class DefaultActionListProviderTest extends TestCase {
  ...
  private DefaultActionListProvider createProvider(List<String> browsers, int port,
      String serverAddress, boolean reset, List<String> tests, Set<ActionListProcessor> processors) {
