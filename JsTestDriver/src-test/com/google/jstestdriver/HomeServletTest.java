...
public class HomeServletTest extends TestCase {
  ...
  public void testDisplayInfo() throws Exception {
    ...
    assertEquals("<html><head><title>JsTestDriver</title></head><body><a href=\"/capture\">"
        + "Capture This Browser</a><br/><a href=\"/capture?strict\">Capture This Browser in"
        + " strict mode</a><br/><p><strong>Captured Browsers:</strong></p><p>Id: 1<br/>"
        + "Name: browser<br/>Version: 1.0<br/>Operating System: OS<br/>"
        + "Currently waiting...<br/><p>Loaded files:<ul></ul>"
        + "</p></body></html>", stream.toString());
  }
}
