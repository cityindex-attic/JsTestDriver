...
public class ExcludeResourceHandler extends AbstractHandler {
  ...
  private final Set<String> excluded = Sets.newHashSet();
  private final ResourceHandler resourceHandler;

  public ExcludeResourceHandler(ResourceHandler resourceHandler) {
  ...
  public void handle(String target, HttpServletRequest req, HttpServletResponse resp, int dispatch)
    ...
    if (!excluded.contains(target)) {
      resourceHandler.handle(target, req, resp, dispatch);
    }
  }
}
