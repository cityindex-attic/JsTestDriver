...
public class DirectoryScanner
    ...
    private void checkIncludePatterns() {
        ...
        if (newroots.containsKey("") && basedir != null) {
            ...
            // directories
            Iterator<Map.Entry<String, String>> it = newroots.entrySet().iterator();
    ...
    protected void scandir(File dir, String vpath, boolean fast) {
        ...
        if (newfiles == null) {
            if (!dir.exists()) {
                ...
                throw new DirectoryScannerException("IO error scanning directory '"
                                         + dir.getAbsolutePath() + "'");
            }
        }
    ...
    private void processIncluded(String name, File file, Vector<String> inc, Vector<String> exc,
      Vector<String> des) {
