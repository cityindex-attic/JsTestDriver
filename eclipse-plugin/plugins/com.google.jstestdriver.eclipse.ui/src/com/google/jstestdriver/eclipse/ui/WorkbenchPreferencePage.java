...
public class WorkbenchPreferencePage extends FieldEditorPreferencePage
  ...
  protected void createFieldEditors() {
    ...
    addField(new DirectoryFieldEditor(SAFARI_PATH, "Path to Safari", getFieldEditorParent()));
    addField(new DirectoryFieldEditor(FIREFOX_PATH, "Path to Firefox", getFieldEditorParent()));
    addField(new DirectoryFieldEditor(CHROME_PATH, "Path to Chrome", getFieldEditorParent()));
    addField(new DirectoryFieldEditor(IE_PATH, "Path to IE", getFieldEditorParent()));
    addField(new DirectoryFieldEditor(OPERA_PATH, "Path to Opera", getFieldEditorParent()));
  }
