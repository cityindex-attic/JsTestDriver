...
import com.google.jstestdriver.eclipse.ui.launch.model.EclipseJstdBrowserRunResult;
...
public class FailureOnlyViewerFilterTest extends TestCase {
  ...
  public void testSelect() throws Exception {
    ...
    assertFalse(filter.select(null, null, testcase1));
    assertTrue(filter.select(null, null, testcase2));
    assertTrue(filter.select(null, null, testcase3));
    
    assertFalse(filter.select(null, null, testcase1.getChildren().iterator().next()));
    ...
    assertTrue(filter.select(null, null, testcase3.getChildren().iterator().next()));
  }
}
